"""
Это исключительно вспомогательная программа

Она берет все изображения с расширением png из папки original_documents,
поворачивает их на 90, 180 и 270 градусов и сохраняет в папку test_data
(test_data будет создана автоматически)

При необходимости пополнить список тестовых документов, новые образцы требуется загрузить в папку original_documents и прогнать данный код
"""
